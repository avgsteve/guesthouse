...
if (mapBox) {
  ...
  console.log("\nThe locations data in #map tag is:\n");
...
if (userPasswordForm) {
  userPasswordForm.addEventListener('submit', /*#__PURE__*/function () {
    var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(element) {
      var btnSavePwd, passwordCurrent, newPassword, passwordConfirm;
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              return _context.abrupt("return", showAlert('error', 'Your NEW password doesn\'t match ! Please check them again!'));
            ...
            case 11:
              ...
              //
              btnSavePwd.textContent = 'Save password';
              return _context.abrupt("return", showAlert('error', 'Please check your current password!'));

            case 14:
              _context.next = 16;
              return updateSettings( // first argument (as obj):
...
var alertMessage_fromBody = document.querySelector('body').dataset.alert; //Get the dataset attribute "alert" and use its value (the error message set by .pug file) for showAlert() to decide what kind of alert message to be displayed

if (alertMessage_fromBody) showAlert('success', alertMessage_fromBody, 6); // function showAlert(errorType, errorMessage, displayDuration_inSeconds = 5)
